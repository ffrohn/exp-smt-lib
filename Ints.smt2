(theory Ints
 ...
 :comment
 "proposal of an extension of the theory Ints with integer exponentiation
  based on the following file by Cesare Tinelli: https://smt-lib.org/theories-Ints.shtml
 "
 ...
 "For every expanded signature, the instance of Ints with that
  ...
  - ** as exponentiation if the second argument is non-negative, and as 0,
    otherwise, i.e., (** n m) is n^m if m is non-negative and 0 if m is
    negative,
